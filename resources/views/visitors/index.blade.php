                ...
                <div class="row align-items-center gx-5">
                    <div class="col-lg-6">
                        <div class="hero-content">
                            ...
                            <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">Banc Online S-abadel transformed the digital banking industry using data and technology more than ten years ago. We are now one of the largest digital banking providers, dedicated to innovating, simplifying, and humanizing
                                banking.</p>
                    ...
                    <div class="col-lg-6 order-lg-1 order-md-2 order-2" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                        <div class="wh-content">
                            <div class="content-title style1">
                                ...
                                <p>Banc Online S-abadel transformed the credit card business using data and technology more than ten years ago. We are now one of the largest digital banking providers, dedicated to innovating, simplifying, and humanizing
                                    banking.</p>
                            </div>
                            <div class="feature-item-wrap">
                                <div class="feature-item">
                    ...
                    <div class="col-lg-6 order-lg-2 order-md-1 order-1" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                        <div class="row align-items-end">
                            <div class="col-6 wh-img-wrap">
                                <img src="{{ asset('bsassets/temp/custom/assets/img/shape-2.png') }}" alt="Image" class="wh-shape-one moveHorizontal">
                                <div class="wh-img">
                                    <img src="{{ asset('bsassets/temp/custom/assets/img/why-choose-us/wh-img-4.jpg') }}" alt="Image">
                                </div>
                                <div class="wh-img">
                                    <img src="{{ asset('bsassets/temp/custom/assets/img/why-choose-us/wh-img-5.jpg') }}" alt="Image">
                                </div>
                            </div>
                            <div class="col-6 wh-img-wrap">
                                <div class="wh-img">
                                    <img src="{{ asset('bsassets/temp/custom/assets/img/shape-3.png') }}" alt="Image" class="wh-shape-two bounce">
                                    <img src="{{ asset('bsassets/temp/custom/assets/img/why-choose-us/wh-img-6.jpg') }}" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/usa.png') }}" alt="Image"></div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/eu.png') }}" alt="Image"></div>
                            <div class="currency-info">
                                <h3>EUR - Euro</h3>
                                <p></p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/uk.png') }}" alt="Image"></div>
                            <div class="currency-info">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/canada.png') }}" alt="Image"></div>
                            <div class="currency-info">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/japan.png') }}" alt="Image"></div>
                            <div class="currency-info">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/newzland.png') }}" alt="Image"></div>
                            <div class="currency-info">
                                <h3>NZD - NZ Dollar</h3>
                                <p></p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="currency-card">
                            <div class="currency-flag"><img src="{{ asset('bsassets/temp/custom/assets/img/flag/france.png') }}" alt="Image"></div>
                            <div class="currency-info">
            ...
            <div class="container">
                ...
                <div class="testimonial-slider-two owl-carousel">
                    ...
                    <div class="testimonial-card style3" style="min-height: 300px;">
                        ...
                        <p class="client-quote">I opened a checking and savings account at Banc Online S-abadel on McHenry in Modesto, California. The teller who helped me was a pleasure to work with. She was very knowledgeable and through setting up my accounts. She made my
                    ...
                    <div class="testimonial-card style3" style="min-height: 300px;">
                        ...
                        <p class="client-quote">I've been with Banc Online S-abadel for four years. I went through a loan modification with them, as well as a six-month forbearance. I also have a credit card with them, which they have cancelled after every late payment, as well
